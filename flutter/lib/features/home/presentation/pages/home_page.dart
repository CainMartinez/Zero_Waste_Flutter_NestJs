...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          HomeHeroHeader(
            ...
            badges: const [
              AppBadge(label: 'Cero Desperdicios', icon: Icons.eco, color: Colors.teal),
              AppBadge(
          ...
          // Dos cards pequeñas informativas
          Row(
            children: const [
              Expanded(
                child: InfoSmallCard(
          ...
          // Banner de fidelidad con gradiente
      ...
      // Barra inferior con CTA global (usa tu AppButton internamente)
      bottomNavigationBar: PrimaryCtaBar(
        label: 'Ver Menú Sostenible',
